        ...
        useEffect(() => {
                (async () => {
                        ...
                        try {
                                ...
                                console.error(err);
                                setError(`Failed to fetch quizzes. ${err instanceof Error ? err.message : ''}`);
                        } finally {
                                setLoading(false);
                        }
                })();
        ...
        return (
                <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-4 sm:p-6">
                        <div className="max-w-7xl mx-auto">
                                {/* Header */}
                                <div className="mb-6">
                                        <h1 className="text-3xl sm:text-4xl font-bold text-gray-800 mb-1">Quiz Dashboard</h1>
                                ...
                                <div className="mt-6 md:mt-8">
                                        <div className="flex items-center justify-between w-full max-w-2xl mx-auto px-1 sm:px-2">
                                                <Button onClick={handlePrevious} disabled={currentIndex === 0} variant="outline" size="icon" className="shrink-0">
                ...
                <Card className="bg-white/80 backdrop-blur-sm border-0 shadow-lg hover:shadow-xl transition-all hover:-translate-y-1 w-full">
                        <CardHeader className="pb-3">
                                <div className="flex items-center justify-between">
                                        ...
                                        <Button variant="ghost" size="sm" className="shrink-0 text-blue-600 px-2" onClick={() => window.open(quizLinkHref, '_blank')} disabled={quizLinkHref === '#'}>
                        ...
                        <CardContent className="space-y-3 sm:space-y-4">
                                <div className="text-center p-3 sm:p-4 bg-gray-50 rounded-lg">
                                        <div className={`text-2xl sm:text-3xl font-bold ${getScoreColor(quiz.marks_obtained)} mb-1`}>{quiz.marks_obtained}%</div>
                                ...
                                <div className="text-center text-xs sm:text-sm text-gray-600 border-t pt-2 sm:pt-3">Total Questions: <span className="font-semibold">{totalQuestions}</span></div>
                        </CardContent>
                </Card>
        );
}
